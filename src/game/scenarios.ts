  ...
  const base: import('./types').GaugeConfig[] = [
    {
      ...
      driftRate: 0.21, noiseAmplitude: 1.0, decayRate: 0.35,
    ...
    },
    {
      ...
      greenMax: 60, amberMax: 80,
      driftRate: 0.175, noiseAmplitude: 0.8, decayRate: 0.30,
      valveReduction: 14, valveCooldown: 3500,
    },
    {
      id: 'w2', label: 'W₂', unit: '%',
      ...
      greenMax: 60, amberMax: 80,
      driftRate: 0.14, noiseAmplitude: 0.7, decayRate: 0.25,
      valveReduction: 14, valveCooldown: 3500,
    },
  ];
  if (overrides) {
...
export const scenarios: ScenarioConfig[] = [
  ...
  /* ── B: Gas Mixture Balance ── */
  {
    ...
    gauges: defaultGauges({
      ...
      w2: { initialValue: 40, driftRate: 0.21, noiseAmplitude: 0.8 },
    }),
    output: {
      label: 'Process Output',
      baseline: 50, initialValue: 50,
      threshold: 85, safeMax: 80,
      driftRate: 0.105, decayRate: 0.25,
      noiseAmplitude: 0.7,
    },
    initialSystemOn: true,
    initialAlarmActive: false,
  ...
  /* ── C: Alarm Response ── */
  {
    ...
    gauges: defaultGauges({
      ...
      w2: { initialValue: 48, driftRate: 0.098 },
    }),
    output: {
      label: 'Process Output',
      baseline: 50, initialValue: 60,
      threshold: 85, safeMax: 80,
      driftRate: 0.07, decayRate: 0.20,
      noiseAmplitude: 0.5,
    },
  ...
  /* ── D: Sudden Surge ── */
  {
    ...
    gauges: defaultGauges({
      ...
      w2: { initialValue: 34, driftRate: 0.084 },
    }),
    output: {
      label: 'Reactor Output',
      baseline: 50, initialValue: 48,
      threshold: 85, safeMax: 80,
      driftRate: 0.084, decayRate: 0.35,
      noiseAmplitude: 0.5,
    },
    initialSystemOn: true,
    initialAlarmActive: false,
